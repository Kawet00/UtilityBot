...
module.exports = {
    ...
    run: async (client, message, args, Discord) => {
        ...
        message.reply({
            ...
            .setTitle(lang.commands.help.helpSp[0].replace('{PREFIX}', prefix))
            .setDescription(lang.commands.helpa[4])
            .addFields({
                name: lang.commands.helpa[5],
                value: lang.commands.help.helpSp[1]
            }, {
                name: lang.commands.helpa[6],
                value: lang.commands.help.helpSp[2].replace('{PREFIX}', prefix),
                inline: true
            }, {
