...
module.exports = {
    ...
    run: async(client, interaction) => {
        ...
        interaction.user.send({
            ...
            .setTitle(lang.commands.help.helpDW[1].replace('{PREFIX}', prefix))
            .setDescription(lang.commands.helpa[4])
            .addFields({
                name: lang.commands.helpa[5],
                value: lang.commands.help.helpDW[2]
            }, {
                name: lang.commands.helpa[6],
                value: lang.commands.help.helpDW[3].replace('{PREFIX}', prefix),
                inline: true
            }, {
